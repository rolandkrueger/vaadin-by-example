 ...
 * session. These two scopes are the common session scope and the new UI scope.
 * The UI scope represents the data needed for the contents of one browser
 * window or tab from the same session.
 * </p>
 * 
 */
// We're using @PreserveOnRefresh so that no new UI object will be created if
// the user reloads the pages.
@PreserveOnRefresh
public class MainApplicationUI extends UI {
	...
	protected void init(VaadinRequest request) {
		...
		// multiplied in memory for each new UI object.
