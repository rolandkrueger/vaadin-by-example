...
/**
 * This is a specialized {@link com.vaadin.data.util.BeanItemContainer} which redefines the filtering
 * functionality by overwriting method
 * {@link com.vaadin.data.util.AbstractInMemoryContainer#addFilter(com.vaadin.data.Container.Filter)}.
 * This method is called internally by the filtering code of a ComboBox.
 */
public class SuggestingContainer extends BeanItemContainer<WikipediaPage> {

  private WikipediaPageTitleAccessService service;

  public SuggestingContainer(WikipediaPageTitleAccessService service) throws IllegalArgumentException {
  ...
  /**
   * The sole purpose of this {@link com.vaadin.data.Container.Filter} implementation is to transport the
